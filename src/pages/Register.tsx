...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#060010] relative overflow-hidden">
      {/* Fix para autocompletado del navegador */}
        ...
        <div className="flex items-center justify-center min-h-screen w-screen relative z-10 px-4 py-10">
          ...
          >
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#060010] px-2 text-gray-500 tracking-widest font-bold">o continúa con</span></div>
            </div>

            {/* BOTÓN GOOGLE */}
            <button
              type="button"
              onClick={() => toast.info("Conexión con Google próximamente...")}
              className="w-full bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-xl p-3 font-bold transition-all flex items-center justify-center gap-3 active:scale-95"
            >
